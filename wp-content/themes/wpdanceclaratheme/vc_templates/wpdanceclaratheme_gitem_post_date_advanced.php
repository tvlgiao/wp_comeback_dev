<?php
/**
 * This file is almost copied from vc_gitem_post_data.php
 */
...
// Theme changed this line
$content = '{{ wpdanceclaratheme_post_date_advanced:' . http_build_query(array('date_format' => @$atts['date_format'])) . '}}';
