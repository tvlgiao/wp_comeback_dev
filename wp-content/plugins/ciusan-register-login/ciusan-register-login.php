...
function crl_admin__menu(){
	...
	if(!$main_menu_exists){
		...
		add_submenu_page('ciusan-plugin', 'Submit a Donation', 'Submit a Donation', 'manage_sites', 'ciusan-submit-donation', 'ciusan_submit_donation');
	}
	add_submenu_page('ciusan-plugin', 'Register Login', 'Register Login', 'manage_sites', 'ciusan-register-login','ciusan_register_login');
}
